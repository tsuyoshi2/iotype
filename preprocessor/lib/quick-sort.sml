...
in
   val sortList = fn z => make (Array.fromList, Array.foldr op :: nil) z
   val sortVector = fn z => make (
      fn v => Array.tabulate (Vector.length v, fn i => Vector.sub (v, i))
      , fn a => Vector.tabulate (Array.length a, fn i => Array.sub (a, i))
   ) z
end
